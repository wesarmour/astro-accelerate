...
Introduction
===
AstroAccelerate is a GPU accelerated software package for real-time data processing of time-domain radio astronomy data. AstroAccelerate contains commonly used signal processing techniques used in time-domain radio astronomy such as de-dispersion, single pulse search, periodicity search, Fourier domain acceleration search and others. AstroAccelerate is written using CUDA and for NVIDIA GPUs.
...
and the proceedings
* https://arxiv.org/abs/1910.08324
...
## Selecting the Graphics Processing Unit (GPU)
